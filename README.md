...
* I will be starting the tasks in Python initially, as that is what I am currently learning
* I may not use the best/most efficient method to solve each task
...
[**Find PI to the Nth Digit**](https://github.com/simonwillcock/Programming101/blob/master/Numbers/pi.py) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/simonwillcock/Programming101/blob/master/Numbers/fibonacci.py) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/simonwillcock/Programming101/blob/master/Numbers/primefactors.py) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/simonwillcock/Programming101/blob/master/Numbers/nextprime.py) – Have the program find prime numbers until the user chooses to stop asking for the next one.

**Find Cost of Tile to Cover W x H Floor** – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

**Mortgage Calculator** – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

[**Change Return Program**](https://github.com/simonwillcock/Programming101/blob/master/Numbers/changecalc.py)– The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.
...
[**Reverse a String**](https://github.com/simonwillcock/Programming101/blob/master/Text/stringreverse.py) – Enter a string and the program will reverse it and print it out.
